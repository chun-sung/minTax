...
export async function POST(req) {
   ...
   try{
       await pool.query(`
           INSERT INTO comments(article_idx, regist_userid, nickName, comment, regist_date)
           Values
           ('${body.article_idx}','${body.regist_userid}','${body.nickName}', '${body.comment}', '${body.regist_date}') 
       `);         
